...
class data_parser:
    ...
    def add_3b_feature(self, X, raw_path, path_to, stock_file, file_to_save):
        ...
        Z90 = 1.64 # Disguised value
        PERCENT = 0.9 #Disguised value
        '''--------------------- Normal Basestock -----------------------'''
...
raw_path = 'C:\TheZinc\P\Warehouse replenishment\mnsc.2022.4564 (1)\replication_package_MS-FTBDA-20-01585\E2E-model-code\Data'
process_path = 'C:\TheZinc\P\Warehouse replenishment\mnsc.2022.4564 (1)\replication_package_MS-FTBDA-20-01585\E2E-model-code\Data'
output_path = 'C:\TheZinc\P\Warehouse replenishment\mnsc.2022.4564 (1)\replication_package_MS-FTBDA-20-01585\E2E-model-code\Data'
...
quantile_list = [85] # Disguised. Example: [85]
quantile_window_list = [7, 14, 30] # Disguised. Example: [7, 14, 30]
mean_window_list = [7, 14, 30] # Disguised. Example: [7, 14, 30]
pred_len_list = [7, 3] # Disguised. Example: [7, 3]
